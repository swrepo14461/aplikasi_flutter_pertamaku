...
class _ProdukFormState extends State<ProdukForm> {
  ...
  _textboxNamaProduk() {
    return TextField(decoration: const InputDecoration(hintText: "masukkan nama produk", labelText: "Nama Produk"),
      controller: _namaProdukTextboxController,);
  }

  _textboxHargaProduk() {
    return TextField(decoration: const InputDecoration(hintText: "masukkan harga", labelText: "Harga"),
